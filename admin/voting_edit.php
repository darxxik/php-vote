...
else
{
	...
	<div id="odpovedi">
		<strong>Možnost 1: </strong><input class="moznost" type="textfield" name="possibility_1" size="20" placeholder="Možnost 1">
		<strong>Možnost 2: </strong><input class="moznost" type="textfield" name="possibility_2" size="20" placeholder="Možnost 2"><br/>
		<strong>Možnost 3: </strong><input class="moznost" type="textfield" name="possibility_3" size="20" placeholder="Možnost 3">
		<strong>Možnost 4: </strong><input class="moznost" type="textfield" name="possibility_4" size="20" placeholder="Možnost 4"><br/>
		<strong>Možnost 5: </strong><input class="moznost" type="textfield" name="possibility_5" size="20" placeholder="Možnost 5">
		<strong>Možnost 6: </strong><input class="moznost" type="textfield" name="possibility_6" size="20" placeholder="Možnost 6"><br/>
		<strong>Možnost 7: </strong><input class="moznost" type="textfield" name="possibility_7" size="20" placeholder="Možnost 7">
